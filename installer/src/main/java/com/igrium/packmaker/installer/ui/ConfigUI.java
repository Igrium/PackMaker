...
import com.igrium.packmaker.installer.Installer;
...
public class ConfigUI {
    ...
    private final InstallerUI installerUI;

    public ConfigUI(InstallerUI installerUI) {
    ...
    private void browseMinecraftDirectory() {
        ...
        fc.showOpenDialog(installerUI.getFrame());
